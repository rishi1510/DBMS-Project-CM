...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <div class="container-fluid">
        <a class="navbar-brand" href="cracc.php">
    ...
    <div class="row justify-content-md-center">
        ...
        <h1 class="text-center">Courier Login</h1><br>
    <form name="f1" action="<?php
    echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
        Email:<br><input type="email" name="email" id="email" value="<?php echo $email;?>" required/><br><br>
        Password:<br><input type="password" name="pass" id="pass" required/><br><br>
