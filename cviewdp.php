    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
      <div class="container-fluid">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="cviewdp.php">
        ...
        <div class="container border border-3   rounded-3 p-5 bg-light">
            <h2>Outgoing packages:</h2><br>
              ...
              if($count1 == 0) {
                ...
                echo "<table class='table table-hover text-center'><tr><th>P_Code</th><th>Receiver Name</th><th>Delivery Date</th></tr>";
            ...
            <h2>Incoming Packages:</h2><br>
              ...
              if($count2 == 0) {
                ...
                echo "<table class='table table-hover text-center'><tr><th>P_Code</th><th>Sender Name</th><th>Delivery Date</th></tr>";
